...
- **Vanilla CSS**: Custom-built styling for a unique, premium look.

## Project Structure

All core application logic and components are contained in a single file for simplicity:
- `src/App.jsx`: Main application logic, state, and UI components.
- `src/index.css`: Custom design system and styling.
...
2. Open your terminal in the `SPA` folder.
